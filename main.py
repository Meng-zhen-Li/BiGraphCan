...
adj, num_split, features, adj_train, training_neg_edges, testing_pos_edges, testing_neg_edges = load_data(dataset_str)
...
if len(emb) > 1:
    ...
    emb = emb[0]
auc_roc, auc_pr = LinkPrediction(emb, nx.from_numpy_matrix(adj_train.todense()), training_neg_edges, testing_pos_edges, testing_neg_edges)